...
//#define CDEPTH 
channel int boundary1 CDEPTH;
channel int boundary2 CDEPTH;
...
#pragma unroll
    ...
    write_channel_altera(boundary1, b);
  }
}
...
#pragma unroll
  ...
  for (int j = 1; j < max_rows - 1; ++j) {
    int diag = sr[0];
    //int left = input_itemsets_v[j];
    int left = read_channel_altera(boundary1);
    sr[0] = left;
...
#pragma unroll
    ...
    write_channel_altera(boundary2, b);
  }
}
