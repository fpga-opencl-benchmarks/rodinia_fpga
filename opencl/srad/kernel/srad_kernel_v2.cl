...
__attribute__((num_simd_work_items(PREP_SIMD)))
__attribute__((reqd_work_group_size(NUMBER_THREADS,1,1)))
__kernel void prepare_kernel(long          d_Ne,
                    __global fp*  restrict d_I,									// pointer to output image (DEVICE GLOBAL MEMORY)
                    __global fp*  restrict d_sums,								// pointer to input image (DEVICE GLOBAL MEMORY)
...
__attribute__((reqd_work_group_size(NUMBER_THREADS,1,1)))
__kernel void reduce_kernel(long          d_no,									// number of sums to reduce
                            int           d_mul,									// increment
                            ...
                            int           gridDim)
{
	...
	// Lingjie Zhang modification at Nov 1, 2015
...
__attribute__((num_simd_work_items(SRAD2_SIMD)))
__attribute__((reqd_work_group_size(NUMBER_THREADS,1,1)))
