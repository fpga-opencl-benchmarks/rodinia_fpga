...
void run_bfs_gpu(int no_of_nodes, Node *h_graph_nodes, int edge_list_size, \
	...
	TimeStamp start, end;
	int k = 0;
	cl_mem d_graph_nodes = NULL, d_graph_edges = NULL, d_graph_mask = NULL, d_updating_graph_mask = NULL, \
			d_graph_visited = NULL, d_cost = NULL, d_over = NULL;
	try{
		...
		//--statistics
		printf("Kernel was executed %d times\n",k);
...
int main(int argc, char * argv[])
{
	...
	char *h_graph_mask = NULL, *h_updating_graph_mask = NULL, *h_graph_visited = NULL;
