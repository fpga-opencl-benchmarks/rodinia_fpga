                                ...
                                int version)
{
	...
	CL_SAFE_CALL( clSetKernelArg( kernel, 3, sizeof(cl_mem), (void *) &recordsD) );
	CL_SAFE_CALL( clSetKernelArg( kernel, 4, sizeof(cl_mem), (void *) &currKnodeD) );
	CL_SAFE_CALL( clSetKernelArg( kernel, 5, sizeof(cl_mem), (void *) &offsetD) );
	CL_SAFE_CALL( clSetKernelArg( kernel, 6, sizeof(cl_mem), (void *) &keysD) );
	CL_SAFE_CALL( clSetKernelArg( kernel, 7, sizeof(cl_mem), (void *) &ansD) );
        
	if (!is_ndrange_kernel(version)) {
		CL_SAFE_CALL( clSetKernelArg(kernel, 8, sizeof(count), (void *)&count) );
		CL_SAFE_CALL( clSetKernelArg(kernel, 9, sizeof(order), (void *)&order) );
        }
